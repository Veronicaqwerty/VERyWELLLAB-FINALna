                ...
                <div class="banner-text">
                    <div class="banner-cell">
                        <div class="logo-container">
                            <img src="img/logo22.png" alt="SavorBite Logo" class="logo">
                        </div>
                        <h1>SavorBites</h1>
                        <h2>Indulge in Flavorful Delights,  <span class="typer" id="some-id" data-delay="200" data-delim=":" data-words="Anytime!:Anywhere!" data-colors="red"></span><span class="cursor" data-cursorDisplay="_" data-owner="some-id"></span></h2>
                        <div class="book-btn">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        <div class="about-images">
                            <img class="about-inset" src="images/mains.jpg" alt="About Main Image">
                            <img  class="about-main" src="images/ins.jpg" alt="About Inset Image">
                        </div>
                    </div>
                </div>
                <!-- end col -->
    ...
    <div class="special-menu pad-top-100 parallax">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        <h2 class="block-title color-white text-center"> Special's </h2>
        ...
        <div class="footer-box pad-top-70">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="footer-box-c">
                                ...
                                <p>
                                    ...
                                    <span><a href="#">support@savorbite.com</a></span>
                                </p>
                            </div>
                            <!-- end footer-box-c -->
                        </div>
            ...
            <div id="copyright" class="copyright-main">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h6 class="copy-title"> Copyright &copy; 2023 Savor Bite is powered by <a href="#" target="_blank"></a> </h6>
                        </div>
                    </div>
                    <!-- end row -->
                </div>
